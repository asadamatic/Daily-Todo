...
class _CustomChartState extends State<CustomChart> {
  @override
  Widget build(BuildContext context) {
    return Consumer<ValueNotifier<DateTime>>(builder: (context, date, child) {
      return Consumer<CheckListNotifier>(builder: (context, data, child) {
        List<Series<DayPerformance, String>> series = [
          Series(
              id: 'Performance',
              data: data.getDataForGraph(date.value),
